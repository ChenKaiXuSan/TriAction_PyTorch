...
#PBS -N K_kt2
#PBS -o logs/pegasus/K_kpttoken_fold2_out.log
#PBS -e logs/pegasus/K_kpttoken_fold2_err.log

# kpt as a plain sequence token instead of a query
