...
#PBS -N N4_aux_pose
#PBS -o logs/pegasus/N4_mv_vivit_aux_pose_out.log
#PBS -e logs/pegasus/N4_mv_vivit_aux_pose_err.log
...
run_exp "N4_mv_vivit_aux_pose" \
    ...
    model.mv_vivit_aux_pose_weight=0.5
