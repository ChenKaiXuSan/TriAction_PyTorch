...
#PBS -N N3_unfrz6
#PBS -o logs/pegasus/N3_mv_vivit_unfreeze6_out.log
#PBS -e logs/pegasus/N3_mv_vivit_unfreeze6_err.log
...
run_exp "N3_mv_vivit_unfreeze6" \
    ...
    model.mv_vivit_unfreeze_last_layers=6
