...
#PBS -N N2_unfrz4_reg
#PBS -o logs/pegasus/N2_mv_vivit_unfreeze4_reg_out.log
#PBS -e logs/pegasus/N2_mv_vivit_unfreeze4_reg_err.log
...
run_exp "N2_mv_vivit_unfreeze4_reg" \
    train.view=multi \
    ...
    model.mv_vivit_fusion_layers=1 \
    model.mv_vivit_dropout=0.3
