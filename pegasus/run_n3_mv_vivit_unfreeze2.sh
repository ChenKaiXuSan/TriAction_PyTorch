...
#PBS -N N3_unfrz2
#PBS -o logs/pegasus/N3_mv_vivit_unfreeze2_out.log
#PBS -e logs/pegasus/N3_mv_vivit_unfreeze2_err.log
...
run_exp "N3_mv_vivit_unfreeze2" \
    ...
    model.mv_vivit_unfreeze_last_layers=2
