...
#PBS -N nA_transformer
#PBS -o logs/pegasus/A_front_rgb_transformer_noes_out.log
#PBS -e logs/pegasus/A_front_rgb_transformer_noes_err.log

source "${TRIACTION_REPO_ROOT:-/work/SKIING/chenkaixu/code/TriAction_PyTorch}/pegasus/run_common.sh"

run_exp "A_front_rgb_transformer_noes" \
    train.view=single \
