...
#PBS -N nT_no_gate
#PBS -o logs/pegasus/T_mid_no_gated_aggregation_noes_out.log
#PBS -e logs/pegasus/T_mid_no_gated_aggregation_noes_err.log

source "${TRIACTION_REPO_ROOT:-/work/SKIING/chenkaixu/code/TriAction_PyTorch}/pegasus/run_common.sh"

run_exp "T_mid_no_gated_aggregation_noes" \
    train.view=multi \
